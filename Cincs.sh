...
#######	Copyright 2014 Jeffrey Kendrick   Cincs is distributed under the terms of the GNU General Public License	  ##########
####################################################################################################################################
#!/bin/bash
...
while :
	...
	do
		...
		echo "5  Configure SELinux for vsFTP"
...
#	Start NFS Menu
			4) echo "Configure NFS"
				while :
					do
						echo "1 View exports"
						echo "2 Boolean configuration (under development - some booleans deleted in RHEL 6"
						echo "3 Batch write for NFS Booleans (will not work until booleans are removed)"
						echo "4 Up one level"
						echo ""
